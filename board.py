...
########################################################################################
# self note: need to find how this thing finds who moves next, and make it check if theres
# any legal moves for that colour to make. if not, other colour wins
# step thorugh debugger: http://stackoverflow.com/questions/4929251/can-you-step-through-python-code-to-help-debug-issues
########################################################################################
